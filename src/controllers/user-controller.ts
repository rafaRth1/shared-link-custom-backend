...
import { RequestUser } from '../interface/RequestUser.js';
...
const profileUser = (req: RequestUser, res: Response) => {
	res.json(req.user);
};

const createNicknameUser = (req: Request, res: Response) => {
...
const profileLink = async (req: Request, res: Response) => {
